...
BasicGame.Level1.prototype = {
	create: function() { 
		...
		BasicGame.music.play(); // Start the music
		...
		//create banana token
        this.token = this.game.add.sprite(180, 105, 'token');
    ...
    updateTokenPosition: function() {
		...
		var tokenPosition = [
            {x: 180, y: 105}, {x: 620, y: 105}, 
            {x: 80, y: 345}, {x: 720, y: 345}, 
			{x: 300, y: 585}, {x: 500, y: 585},
            {x: 180, y: 465}, {x: 620, y: 465} 
        ];
